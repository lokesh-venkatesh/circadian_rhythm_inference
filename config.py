...
if __name__=="__main__":
    scripts = ["data.py", 
               ...
               "plot.py", 
               "latent", 
               "scripts/latent_space_megaplot.py",
               "organise.py"]
    #scripts.extend(["scripts/flatten_pca_day_of_year.py",
    #                "scripts/flatten_pca_temp.py", 
    #                "scripts/flatten_tsne_day_of_year.py",
    #                "scripts/flatten_tsne_temp.py"])
